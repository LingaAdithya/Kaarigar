  ...
  return (
    <div className="bg-background min-h-screen">
      <main className="container mx-auto px-4 py-8">
                  ...
                  <CarouselItem key={artisan.id}>
                    <div className="relative aspect-[3/2] md:aspect-[2.5/1] w-full rounded-lg overflow-hidden shadow-lg">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8 text-white">
                        <h3 className="text-sm font-semibold uppercase tracking-widest">Artisan of the Day</h3>
                        <h2 className="font-headline text-4xl md:text-6xl">{artisan.name}</h2>
        ...
        <section className="mb-16">
          <h2 className="font-headline text-3xl mb-6">Shop by Region</h2>
        ...
        <section>
          <h2 className="font-headline text-3xl mb-6">Curated For You</h2>
                  ...
                  <Card className="overflow-hidden group border-none shadow-sm hover:shadow-lg transition-shadow duration-300 bg-card">
                    <CardContent className="p-0">
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-sm text-muted-foreground">{product.artisan.name}</p>
